...
void initCapture(void)
{
    ...
    TA1CCTL1 = CM_3 | CCIS_0 | CAP | SCS | CCIE;
}

#pragma vector = TIMER1_A1_VECTOR
__interrupt void TIMER1_A1_ISR(void)
{
    switch (__even_in_range(TA1IV, TA1IV_TACCR1))
    {
        case TA1IV_TACCR1:
        {
